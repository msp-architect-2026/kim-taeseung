...
- **서버 부하 없는 프론트엔드 상태 관리:** 사용자별 사주 보관함과 가상 로그인 기능을 제공하면서도 백엔드에 DB를 두지 않고 브라우저 `localStorage`를 활용했습니다. 이를 통해 파드의 완벽한 무상태성(Stateless)을 유지하며 오토스케일링(HPA) 제약을 없앴습니다.
---
...
- **[Backend ↔️ Gemini API]** 개발자 페르소나 및 명리학(시주) 컨텍스트가 주입된 프롬프트 송수신
...
* [🏠 Home](https://github.com/msp-architect-2026/kim-taeseung/wiki)
